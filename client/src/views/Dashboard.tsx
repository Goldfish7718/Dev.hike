            ...
            <Card className="lg:w-2/3 w-full my-4">
              ...
              <div className="flex justify-evenly">
                <Button className="w-full rounded-none" variant="ghost">
                  <Heart size={18} className="mx-1" />
                  48
                </Button>
                <Button className="w-full rounded-none" variant="ghost">
                  <MessageSquare size={18} className="mx-1" />
                  21
                </Button>
                <Button className="w-full rounded-none" variant="ghost">
                  <Users size={18} className="mx-1" />4
                </Button>
              </div>
              <Separator />
              <CardFooter>
                <div className="mt-4 flex gap-2">
                  <Button variant="outline">
                    <MapPin size={18} className="mx-1" /> {post.location}
                  </Button>
                  <Button variant="outline">
                    <Settings size={18} className="mx-1" /> {post.tag}
                  </Button>
                </div>
              </CardFooter>
            </Card>
