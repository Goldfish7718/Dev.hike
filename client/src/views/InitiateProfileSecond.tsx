      ...
      <div className="flex justify-center h-screen items-center my-8">
        <div className="w-full p-4 sm:w-3/4 md:w-1/2"> 
          ...
          <div className="mt-4 flex justify-between">
            <Button variant='link' className="mt-4 md:text-lg"><ChevronLeft className="mx-2" /> Previous</Button>
            <Button variant='link' className="mt-4 md:text-lg">Let's Go! <ChevronRight className="mx-2" /></Button>
          </div>
        </div>
      </div>
    </>
