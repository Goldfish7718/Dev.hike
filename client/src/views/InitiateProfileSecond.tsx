...
import { GithubIcon, InstagramIcon, LinkedinIcon, Plus, Twitter, Link} from "lucide-react"
    ...
    <>
        <div className="flex justify-center h-screen items-center">
          <div className="w-full p-4 sm:w-3/4 md:w-1/2"> 
            ...
            <div className="mt-4">
              <Button className="mt-4 md:text-lg w-full">Connect</Button>
            </div>
            <div className="mt-4 flex justify-between">
              <Button className="mt-4 md:text-lg w-1/6">Previous</Button>
              <Button className="mt-4 md:text-lg w-1/6">Let's Go</Button>
            </div>
          </div>
        </div>
    </>
